#!/usr/bin/env python3
"""
Database operations for the arXiv paper download tool.
...
def record_paper_download(paper_id, title="", authors="", directory="", has_metadata=False, has_pdf=False, category=None):
    """
...
def update_paper_status(paper_id, has_metadata=None, has_pdf=None):
    """
...
def paper_exists(paper_id):
    ...
    try:
        ...
        if has_metadata and has_pdf:
            from utils import get_simplified_paper_id, sanitize_filename
...
def search_local_papers(search_term=None, search_field=None, limit=100):
    """
